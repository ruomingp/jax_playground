...
class MetricsTest(absltest.TestCase):
    def testMetricAccumulator(self):
        ...
        acc.update(dict(a=WeightedScalar(1, 1), b=dict(b1=WeightedScalar(2, 6), b2=WeightedScalar(3, 12))))
        acc.update(dict(a=WeightedScalar(3, 1), b=dict(b1=WeightedScalar(12, 24), b2=WeightedScalar(15, 3))))
